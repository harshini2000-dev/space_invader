## Space Invader game
A classic Space Invaders game built using Pygame, Python.
The user controls a spaceship that can move left and right and shoot bullets to destroy incoming enemies before they reach you.
